...
class Player(GameObject):
    def __init__(self, x0, y0, vx0, vy0):
        ...
        # This variable takes trace of last frame where the player jupmed in order to stop the ascending phase
        self.last_jump=None 
        # The sprite are stored in a dict
        self.sprite={"JUMP" : load_image("red.png") ; "RUN" : load_image("green.png")}
    def choose_sprite(self):
        """
        This funciton choose the good sprite and returns it
        """
